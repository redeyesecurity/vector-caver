...
static CLASSES: &[ClassMeta] = &[
    ClassMeta {
        ...
        category_uid: 2,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","file"],
    },
    ClassMeta {
        uid: 1002,
        name: "Kernel Extension Activity",
        category_uid: 2,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata"],
    },
    ClassMeta {
        uid: 2001,
        name: "Security Finding",
        category_uid: 2,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","finding_info"],
    },
    ClassMeta {
        uid: 3001,
        name: "DNS Activity",
        category_uid: 4,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","query"],
    },
    ClassMeta {
        uid: 3002,
    ...
    ClassMeta {
        ...
        name: "HTTP Activity",
        category_uid: 4,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","http_request","http_response"],
    },
    ClassMeta {
        uid: 3006,
        name: "FTP Activity",
    ...
    ClassMeta {
        ...
        name: "Account Change",
        category_uid: 3,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","user"],
    },
    ClassMeta {
        uid: 4002,
        name: "Authentication",
        category_uid: 3,
        required: &["class_uid","category_uid","activity_id","time","severity_id","status_id","metadata","user"],
    },
    ClassMeta {
        uid: 4003,
    ...
    ClassMeta {
        ...
        category_uid: 3,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","group"],
    },
    ClassMeta {
        uid: 5001,
        name: "Process Activity",
        category_uid: 2,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","process"],
    },
    ClassMeta {
        uid: 5002,
    ...
    ClassMeta {
        ...
        category_uid: 5,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","finding_info","analytic"],
    },
    ClassMeta {
        uid: 6002,
        name: "Vulnerability Finding",
        category_uid: 5,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","finding_info","vulnerabilities"],
    },
    ClassMeta {
        uid: 6003,
        name: "Compliance Finding",
        category_uid: 5,
        required: &["class_uid","category_uid","activity_id","time","severity_id","metadata","finding_info","compliance"],
    },
];
